      ...
      <section class="hero bg-cover bg-center h-screen flex items-center justify-center relative">
        ...
        <div class="relative z-10 text-center px-6">
          ...
          <div class="mt-6 space-x-4">
            <button class="bg-teal-600 hover:bg-teal-700 py-3 px-6 rounded-lg text-lg">Get Started</button>
            <button class="bg-transparent border-2 border-white py-3 px-6 rounded-lg text-lg hover:bg-white hover:text-gray-900">Learn More</button>
          </div>
        </div>
      </section>
    </div>
